...
var or__18195__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18195__auto__)){
return or__18195__auto__;
} else {
var or__18195__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18195__auto____$1)){
return or__18195__auto____$1;
} else {
var or__18195__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18195__auto____$2)){
return or__18195__auto____$2;
} else {
var or__18195__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18195__auto____$3)){
return or__18195__auto____$3;
} else {
...
var n__19080__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19080__auto__)){
var c_25100 = (a[i]);
if(cljs.core.truth_((c_25100["cljsIsDirty"]))){
(c_25100["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__18774__auto__,writer__18775__auto__,opt__18776__auto__){
return cljs.core._write.call(null,writer__18775__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__25104 = c;
var G__25104__$1 = (((G__25104 == null))?null:(G__25104["props"]));
var G__25104__$2 = (((G__25104__$1 == null))?null:(G__25104__$1["argv"]));
return G__25104__$2;
});
...
var G__25106_25107 = (c["cljsRatom"]);
var G__25106_25108__$1 = (((G__25106_25107 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__25106_25107));

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1436069128279